...
//
//     final musicDt = musicDtFromJson(jsonString);

import 'dart:convert';

MusicDt musicDtFromJson(String str) => MusicDt.fromJson(json.decode(str));

String musicDtToJson(MusicDt data) => json.encode(data.toJson());
...
class MusicDt {
    ...
    factory MusicDt.fromJson(Map<String, dynamic> json) => MusicDt(
